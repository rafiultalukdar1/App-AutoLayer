    ...
    */
    ...
    if (
        ...
        */
        ...
        const riskBtn1d =
            document.getElementById("riskBtn1d");

        const riskBtn7d =
            document.getElementById("riskBtn7d");

        const riskBtn1m =
            document.getElementById("riskBtn1m");

        const riskBtn1y =
            document.getElementById("riskBtn1y");


        if (riskBtn1d) {

            riskBtn1d.addEventListener(
                "click",
                function () {
