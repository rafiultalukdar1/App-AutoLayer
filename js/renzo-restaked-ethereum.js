document.addEventListener("DOMContentLoaded", function () {
    ...
    const renderWeather = function (param, api) {
        ...
        return {
            type: "group",
            x: point[0] - weatherIconSize / 2,
            y: point[1] - weatherIconSize / 2,
            children: []
        };
    };
    ...
    if (mainChartElement && typeof echarts !== "undefined") {
        ...
        document
            ...
            ?.addEventListener("click", setChartZoom);
    ...
    const generateWeatherIcons = function (params, api) {
        ...
        return {
            type: "group",
            x: point[0] - iconSize / 2,
            y: point[1] - iconSize / 2,
            children: []
        };
    };
    ...
    if (
        ...
        const setRiskChartZoom = function () {
        ...
        document
            ...
            ?.addEventListener("click", setRiskChartZoom);
