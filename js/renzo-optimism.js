document.addEventListener("DOMContentLoaded", function () {
    ...
    if (typeof echarts !== "undefined") {
        ...
        if (mainChartElement) {
            ...
            // 7D
            document.getElementById("btn7d")?.addEventListener(
                "click",
                function () {
            ...
            // 1M
            document.getElementById("btn1m")?.addEventListener(
                "click",
                function () {
            ...
            // 1Y
            document.getElementById("btn1y")?.addEventListener(
                "click",
                function () {
        ...
        const chartData =
            weatherData2.dataPoints.map(function (entry) {
        ...
        const forecastData =
            weatherData2.forecastData.map(function (entry) {
        ...
        if (chartUpDownElement) {
            ...
            // 1D
            document.getElementById("riskBtn1d")?.addEventListener(
                "click",
                function () {
            ...
            // 7D
            document.getElementById("riskBtn7d")?.addEventListener(
                "click",
                function () {
            ...
            // 1M
            document.getElementById("riskBtn1m")?.addEventListener(
                "click",
                function () {
            ...
            // 1Y
            document.getElementById("riskBtn1y")?.addEventListener(
                "click",
                function () {
